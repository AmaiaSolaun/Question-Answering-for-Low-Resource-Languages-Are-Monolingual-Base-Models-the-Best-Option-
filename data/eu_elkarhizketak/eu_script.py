...
_TRAINING_FILE = "/content/drive/My Drive/Colab Notebooks/EHU_App2_MonoL/data/eu/elkarhizketak-v1.0/train.json"
_DEV_FILE = "/content/drive/My Drive/Colab Notebooks/EHU_App2_MonoL/data/eu/elkarhizketak-v1.0/dev.json"
_TEST_FILE = "/content/drive/My Drive/Colab Notebooks/EHU_App2_MonoL/data/eu/elkarhizketak-v1.0/test.json"
